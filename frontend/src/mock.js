...
export const founderBio = {
  ...
  inception: "Mr. Cardona began developing the concept for Degen's Delight at the age of 19, recognizing a significant opportunity for innovation within the premium spirit-based RTD segment. Degen's Delight is defined by its commitment to quality and consumer preferences: a superior cranberry vodka RTD that is distinctly non-carbonated, offering a cleaner and more sophisticated profile than existing market options.",
